...
SECRET_KEY = 'django-insecure-6i5(pi_-re3d4v2xp0#xr69d(s32itlud7x8d7)8591o*os%15'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True # Cuando es True es porque estamos en modo desarrollo (en local), si lo queremos desplegar en producción, debemos ponerlo a False
...
EMAIL_USE_SSL = False  
EMAIL_PORT = 587
EMAIL_HOST_USER = "toxicodivi@gmail.com"
EMAIL_HOST_PASSWORD = "sxma dxna pxaz rgut"
